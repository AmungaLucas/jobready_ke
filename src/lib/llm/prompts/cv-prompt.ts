...
5. "function" must be one of these exact values: "engineering" | "finance" | "marketing" | "sales" | "operations" | "human_resources" | "technology" | "design" | "customer_service" | "healthcare" | "education" | "legal"
   - IMPORTANT: "marketing" also covers media, broadcast journalism, TV/radio production, news anchoring, video editing, social media management, and content creation. Map all media-related roles to "marketing".
